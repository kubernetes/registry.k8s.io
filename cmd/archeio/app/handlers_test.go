...
func TestMakeV2Handler(t *testing.T) {
	...
	blobs := fakeBlobsChecker{
		knownURLs: map[string]bool{
			"https://prod-registry-k8s-io-us-east-2.s3.us-west-2.amazonaws.com/containers/images/sha256%3Ada86e6ba6ca197bf6bc5e9d900febd906b133eaa4750e6bed647b0fbe50ed43e": true,
		},
	}
	...
	testCases := []struct {
		...
		},
		{
			...
			ExpectedStatus: http.StatusTemporaryRedirect,
			ExpectedURL:    "https://prod-registry-k8s-io-us-east-2.s3.us-west-2.amazonaws.com/containers/images/sha256%3Ada86e6ba6ca197bf6bc5e9d900febd906b133eaa4750e6bed647b0fbe50ed43e",
		},
		{
